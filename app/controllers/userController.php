 ...
 public function confirm_momo()
{
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $orderId = time() . "";
        $redirectUrl = BASE_URL . "user/momo_post";
        $ipnUrl = BASE_URL . "user/checkout";
        $extraData = "";
...
//             $this->userModel->storeMomoInfo($customer_id, $momo_status, $link_data_json);

//             header('Location: ' . BASE_URL . 'frontend/home/momo?success=Nạp momo thành công, vui lòng chờ Admin duyệt đơn nhé.');
//             exit;  
//         }

//         header('Location: ' . BASE_URL . 'frontend/home/momo?error=Lỗi trong quá trình nạp Momo.');
//         exit;
//     }
