    ...
    <div class="container-cart m-5">
        ...
        <?php foreach ($data['orderItems'] as $orderItem): ?>
            <div class="cart-item d-flex align-items-center mt-4">
                ...
                <div class="price me-4"><?= number_format($orderItem['price'], 0, ',', '.') ?> VND</div>
                <div class="quantity-control">
                    <button class="btn btn-sm" onclick="decrement(<?= $orderItem['foodId'] ?>)">-</button>
                    <input id="quantity" type="text" value="<?= $orderItem['quantity'] ?>" class="form-control mx-2">
                    <button class="btn btn-sm" onclick="increment(<?= $orderItem['foodId'] ?>)">+</button>
                </div>
                <div class="subtotal"><?= number_format($orderItem['total_price'], 0, ',', '.') ?> VND</div>
